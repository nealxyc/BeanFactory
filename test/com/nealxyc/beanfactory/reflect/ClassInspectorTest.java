...
public class ClassInspectorTest {
	...
	for(AttributeGetterSetter attr: ci.getAttributeGetterSetterList()){
	    assertThat(attr.getDescriptor().getName(), anyOf(is("Name"), is("Code")));
	    assertTrue( attr.getDescriptor().getType().equals(String.class) ||  attr.getDescriptor().getType().equals(Object.class) );
	}
    }
}
